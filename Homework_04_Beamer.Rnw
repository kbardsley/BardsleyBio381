...
<<fig.align='center',fig.dim=c(2.5,2), fig.cap="This is a plot of random uniform values.",echo=FALSE>>=
...
<<fig.align='left',fig.dim=c(4,2.5), fig.cap="This is a plot of values - with a great caption.",echo=FALSE>>=
# limited space for output
plot(runif(10))
@
\end{block}
