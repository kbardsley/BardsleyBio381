...
% TITLE PAGE DATA--------------------------
\title[Beamer]{How to Use Beamer - A simple example} % The short title appears at the bottom of every slide, the full title is only on the title page

\author{Katie Bardsley} % Your name
...
\medskip
\textit{kbardsle@uvm.edu} % Your email address
}
...
\caption{Beamer makes it easy to include graphics.}
\end{figure}
\end{frame}
...
% SLIDE (2 FIGURES)-----------------------------
\begin{frame}
\frametitle{What if you want more than one figure?}
% Uncomment the code on this slide to include your own image from the same directory as the template  file.
\begin{figure}
  \includegraphics[width=0.475\textwidth]{DSC_0982.jpg}%
  \hfill
  \includegraphics[width=0.475\textwidth]{DSC_0982.jpg}%
% use this format for absolute sizing
%\includegraphics[width=3cm, height=4cm]{filename.jpg}
\caption{This is me after hiking Mt. Crested Butte in Colorado.}
\end{figure}
\end{frame}
...
\begin{frame}[fragile]{It is also possible to include R code.}
\begin{block}
\ However, the margins get weird sometimes.
...
\caption[This is a plot of random uniform values]{This is a plot of random uniform values.}\label{fig:unnamed-chunk-1}
\end{figure}
...
% SLIDE (EMBEDDED R FIGURE)----------------
\begin{frame}[fragile]{We can play with dimensions.}
\begin{block}

\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{figure}

\includegraphics[width=\maxwidth]{figure/unnamed-chunk-2-1} \hfill{}

\caption[This is a plot of values - with a great caption]{This is a plot of values - with a great caption.}\label{fig:unnamed-chunk-2}
\end{figure}
